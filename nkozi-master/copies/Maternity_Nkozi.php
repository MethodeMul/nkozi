...
<form method="post" enctype="multipart/form-data">
	...
	<table id="ANC Consultations" class="display" cellspacing="0" width="400px">
			<tr>
				<td>Number of women attended</td>
				<td><input type="text" id="r_7_1" name="r_7_1" class="numericInput" value="">
				</td>
			</tr>
			<tr>
				<td>Number Women</td>
				<td><input type="text" id="r_8_1" name="r_7_1" class="numericInput" value="">
				</td>
			</tr>
	</table>
	<br>
